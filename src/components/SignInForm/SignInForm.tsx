        ...
        <div className = "bg-slate-900 border text-xl border-orange-500 rounded-xl p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 mt-20 relative">
            ...
            <form action="" >
                <div className = "relative my-6">
                    ...
                    <label htmlFor="" className = "absolute text-white duration-300 transform -traslate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-950 peer-focus:dark:text-blue-950 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-90 peer-focus:-translate-y-6">Tu Email</label>
                ...
                <div className = "relative my-10">
                    ...
                    <label htmlFor="" className = "absolute text-white duration-300 transform -traslate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-950 peer-focus:dark:text-blue-950 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-90 peer-focus:-translate-y-6">Tu Clave</label>
                ...
                <div>
                    <span className= "m-4">¿Nuevo por aqui? <Link href="/signup" className= "text-blue-950">Create una Cuenta</Link></span>
                </div>
            </form>
            </div>
        </div>
